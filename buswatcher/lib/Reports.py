...
def get_reliability(route):
    return pd.read_csv('data/_reliability.csv') # todo generate this here, or read a file made by an updated Generator (that outputs a df to csv not json)
