...
#             self.db.session.commit()
#
#     __tablename__ = 'route_definitons'
#     __table_args__ = {'extend_existing': True}
#
#     rt = Column(Integer(), primary_key=True, index=True, unique=True)
#     nm = Column(String(127))
#     prettyname = Column(String(127))
#     description_short = Column(String(127))
#     description_long = Column(String(127))
#     frequency = Column(String(8))
#     schedule_url = Column(String(255))
#     waypoints = RouteReport.Path # todo 0 how to embed this
#     coordinate_bundle = Column(Text()) # todo 0 how to embed this
