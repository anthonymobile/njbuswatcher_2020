...
map.on('load', function() {
    ...
    var url_waypoints = ("/api/v1/maps?layer=waypoints&rt="+passed_route); // doesnt work
    ...
    // STOPS
    // var url_stops = ("/api/v1/maps?layer=stops&rt=87"); // works
    var url_stops = ("/api/v1/maps?layer=stops&rt="+passed_route); // doesnt work
